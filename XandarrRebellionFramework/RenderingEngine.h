...
public:
	...
	// Default Constructor; gives member properties default values
...
// The Rendering Engine encapsulates the
//
//
...
private:
	...
	// Manages the application window, includeing events.
...
public:
	...
	// Safely destroys a TextureBB object and sets the reference to the
	// argument to nullptr.
	//		@param tex Texture to free from memory {Ref to Pointer}
