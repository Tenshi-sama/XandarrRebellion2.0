...
// the SDL_TEXTUREACCESS_TARGET flag, allowing the texture to be target by
// the renderer.
...
// screen with all rendering operations performed since AcquireRenderTarget
...
// Safely disposes of the current instance of ptr_texture_ then creates
// a new instance of ptr_texture_, using the width and height of the application
